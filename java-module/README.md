...
Step 1 — Baseline: You point it at a directory (e.g., /etc, /var/www, /opt/app). It walks every file, computes SHA-256 hashes, and saves a snapshot. This is your "known good" state.
Step 2 — Verify: You run it again later. It re-scans the same directory, compares the new hashes against the saved baseline, and reports exactly what changed:
